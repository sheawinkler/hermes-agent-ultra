...
Usage:
    ...
    exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.hermes-agent-ultra-agent-ultra")), "skills/red-teaming/godmode/scripts/parseltongue.py")).read())
