...
Works without a Python checkout for checkpoint-manager pure helpers; with sibling `hermes-agent` (or `research/hermes-agent`), also emits Anthropic adapter goldens.
