...
#![allow(clippy::doc_lazy_continuation, clippy::manual_is_multiple_of)]
//! # Setup
//!
...
//! `DYLD_LIBRARY_PATH`.
//!
//! Example `v1.13.3` archives used by the build script:
//!
//! Default static archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.13.3-linux-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-linux-x64-static-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.13.3-linux-aarch64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-linux-aarch64-static-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.13.3-osx-x64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-osx-x64-static-lib.tar.bz2)
//! - macOS arm64:
//!   [sherpa-onnx-v1.13.3-osx-arm64-static-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-osx-arm64-static-lib.tar.bz2)
//! - Windows x64:
//!   [sherpa-onnx-v1.13.3-win-x64-static-MT-Release-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-win-x64-static-MT-Release-lib.tar.bz2)
//!
//! Optional shared archives:
//!
//! - Linux x86_64:
//!   [sherpa-onnx-v1.13.3-linux-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-linux-x64-shared-lib.tar.bz2)
//! - Linux aarch64:
//!   [sherpa-onnx-v1.13.3-linux-aarch64-shared-cpu-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-linux-aarch64-shared-cpu-lib.tar.bz2)
//! - macOS x86_64:
//!   [sherpa-onnx-v1.13.3-osx-x64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-osx-x64-shared-lib.tar.bz2)
//! - macOS arm64:
//!   [sherpa-onnx-v1.13.3-osx-arm64-shared-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-osx-arm64-shared-lib.tar.bz2)
//! - Windows x64:
//!   [sherpa-onnx-v1.13.3-win-x64-shared-MT-Release-lib.tar.bz2](https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.13.3/sherpa-onnx-v1.13.3-win-x64-shared-MT-Release-lib.tar.bz2)
//!
