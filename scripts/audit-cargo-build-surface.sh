...
echo "- Slash-command rendering, autocomplete ranking, alias canonicalization, command catalog presentation, and gateway/tool preview rendering now have a narrow presentation home in \`hermes-cli-ui\`."
...
echo "- Broader terminal UI, checklist, theme, and clipboard extraction should wait for a dedicated TUI crate boundary."
